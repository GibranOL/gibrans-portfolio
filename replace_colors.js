...
const replacements = [
  ...
  { regex: /\btext-gray-300\b/g, replace: 'text-slate-600 dark:text-gray-300' },
  { regex: /\btext-gray-400\b/g, replace: 'text-slate-500 dark:text-gray-400' },
  { regex: /\bbg-background\b/g, replace: 'bg-background' }, // already adapted
